...
export function saveNoteInBrowser(noteObj) {
  let notes;
...
export function _createNoteObject(title, body) {
...
export function _createNoteBody() {
...
// eslint-disable-next-line no-underscore-dangle
export function _createNoteElement(noteObj) {
...
export function localStorageOnLoad() {
...
export function openColorSelectorModal() {
...
export function changeAppColor(event) {
...
export function handleStackEvents(event) {
  if (
